                    ...
                    <div class="">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-xl-6 col-sm-7 landing-main">
                                <h1 class="landing-header mx-3">
                                    Today's the day
                                </h1>
                                <p class="mc-text-large mc-opacity--muted mc-mt-6 mc-mb-9 mx-">
                                ...
                                <div class="d-block d-md-none d-xl-block container mc-mb-10">
                                    <div class="col-12 col-xl-auto d-flex flex-column mc-text--center">
                                        <a class="c-button c-button--full-width c-button--primary c-button--medium"
                                            href="#cart?product_id=62" id="hero-cta" data-toggle="modal"
                                            data-target="#registerModal" onclick="openPaymentModal()">Get Started</a>
                                    </div>
                                    <div
                                ...
                                <div class="d-none d-md-block d-xl-none mc-mb-10">
                                    <div class="row">
                                        <div class="col-auto col-xl-auto d-flex flex-column mc-text--center">
                                            <a class="c-button c-button--full-width c-button--primary c-button--medium"
                                                href="#cart?product_id=62" id="hero-cta" data-toggle="modal"
                                                onclick="openPaymentModal()" data-target="#registerModal">Get
                                                Started</a>
                                        </div>
                            ...
                            <div class="col-sm-12 col-md-12 col-xl-6 pl-0">
                                <img class="h-100 w-100 d-inline-block" src="{{ asset('image.jpg') }}"
        alt="" />
    </div>
...
<div class="d-flex row" style="padding-top: 70px;">
    <div class="col-12 col-md-6 col-xl-6 col-sm-12 landing-main">
        ...
        <div class="d-block d-md-none d-xl-block container mc-mb-10">
            <div class="col-12 col-xl-auto d-flex flex-column mc-text--center">
                <a class="c-button c-button--full-width c-button--primary c-button--medium" href="#cart?product_id=62"
                    id="hero-cta" data-toggle="modal" data-target="#registerModal" onclick="openPaymentModal()">Get
                    Started</a>
            </div>
        ...
        <div class="d-none d-md-block d-xl-none mc-mb-10">
            <div class="row">
                <div class="col-auto col-xl-auto d-flex flex-column mc-text--center">
                    <a class="c-button c-button--full-width c-button--primary c-button--medium"
                        href="#cart?product_id=62" id="hero-cta" data-toggle="modal" onclick="openPaymentModal()"
                        data-target="#registerModal">Get
                        Started</a>
                </div>
                <div class="mc-text--bold mc-opacity--hinted col-xl-7 col-md-7 col-lg-5">
                    <p class="d-none d-xl-inline">
    ...
    <div class="col-sm-12 col-md-12 col-xl-6 pl-0">
        <img class="h-100 w-100 d-inline-block" src="{{ asset('image.jpg') }}" alt="" />
    </div>
</div>
    ...
    <script>
        ...
        cardButton.addEventListener('click', async (e) => {
            ...
            if (error) {
                ...
                axios.post('/api/payment-success',setupIntent)
